...
impl MetadataChunk {
    pub fn id(&self) -> String {
        match self {
            ...
            MetadataChunk::Vorbis(_) => "Vorbis".to_string(),
    ...
    pub fn parse(&self, map: &mut HashMap<String, String>) -> R<()> {
        match self {
            Self::Vorbis(data) => {
            ...
            Self::ID3(data) => {
                ...
                if data.len() >= 10 && &data[0..3] == b"ID3" {
                    ...
                    if size > 0 && data.len() >= (10 + size as usize) {
                        ...
                        match version_major {
                            2 => self.parse_id3v22_frames(tag_data, map),
                            3 | 4 => self.parse_id3v23_v24_frames(tag_data, map, version_major),
